...
export function BlockchainPostCreate({ onSuccess, className }: BlockchainPostCreateProps) {
  const { user } = useUser()
  const { createPost: createOffChainPost, isCreating: isCreatingOffChain } = usePosts()
  const {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const postData = {
        ...
        media_ipfs: mediaFiles.length > 0 ? mediaFiles[0].ipfs_hash : undefined,
          ...
          {isContractAvailable && (
            <div className="flex items-center gap-2 ml-auto">
              <div className="flex items-center gap-1 px-2 py-1 bg-success-500/10 rounded-full">
                ...
                <span className="text-xs text-success-400 font-medium">Blockchain Ready</span>
              </div>
            </div>
          )}
        </CardTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-text-primary">Free Post</h4>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-text-primary">Blockchain Post</h4>
                      <p className="text-sm text-text-tertiary">
          ...
          {error && (
            <div className="flex items-start gap-3 p-4 bg-error-500/10 border border-error-500/20 rounded-lg">
              ...
              <div>
                <p className="font-medium text-error-400">Post Creation Failed</p>
          ...
          {/* Action Buttons */}
          <Flex gap="md" justify="end" className="pt-4 border-t border-border-primary">
            <Button
              type="button"
              variant="ghost"
              onClick={() => {
